...
**** TODO сделать тесты для заказов
***** DONE несправилось
(defn strip-components [hiccup]
  (cond
    (and (vector? hiccup) (fn? (first hiccup)))
...
***** DONE ошибка
****** 
***** понять где считается сума убедится
что считается правельно 
сделав тест
***** кажется вопрос сумой в том что сменился на курсор
