...
**** TODO нажатие на изображение оправляет на редактировнаи
...
**** внести измения из 17
какие ещё есть
*** дочитать по тестированию
** понять могу ли сделать удобное тестирование
*** сделать одиночный тест
*** понять как его запустить
*** как сделать автозапуск после танглинга
*** как работает авто запуск
*** как настраивать сют тест 
*** есть ли удобная команда настройки его на один тест
