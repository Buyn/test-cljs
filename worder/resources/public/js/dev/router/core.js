...
var re_match = ((is_placeholder_QMARK_)?["(","[^/]",min_matches,")"].join(''):part);
...
var full_regex = ["^",base_regex,"$"].join('');
...
return clojure.string.replace.call(null,clojure.string.trim.call(null,(function (){var or__4185__auto__ = route;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25114__$1)].join('')));
...
router.core.process_route = (function router$core$process_route(p__25117){
var vec__25118 = p__25117;
var route = cljs.core.nth.call(null,vec__25118,(0),null);
var defaults = cljs.core.nth.call(null,vec__25118,(1),null);
...
return cljs.core.apply.call(null,cljs.core.dissoc,matches,(function (){var iter__4582__auto__ = (function router$core$remove_empty_matches_$_iter__25121(s__25122){
return (new cljs.core.LazySeq(null,(function (){
var s__25122__$1 = s__25122;
while(true){
var temp__5735__auto__ = cljs.core.seq.call(null,s__25122__$1);
if(temp__5735__auto__){
var s__25122__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__25122__$2)){
var c__4580__auto__ = cljs.core.chunk_first.call(null,s__25122__$2);
var size__4581__auto__ = cljs.core.count.call(null,c__4580__auto__);
var b__25124 = cljs.core.chunk_buffer.call(null,size__4581__auto__);
if((function (){var i__25123 = (0);
while(true){
if((i__25123 < size__4581__auto__)){
var vec__25125 = cljs.core._nth.call(null,c__4580__auto__,i__25123);
var k = cljs.core.nth.call(null,vec__25125,(0),null);
var v = cljs.core.nth.call(null,vec__25125,(1),null);
if(((cljs.core._EQ_.call(null,v,"null")) || (cljs.core.empty_QMARK_.call(null,v)))){
cljs.core.chunk_append.call(null,b__25124,k);

var G__25131 = (i__25123 + (1));
i__25123 = G__25131;
continue;
} else {
var G__25132 = (i__25123 + (1));
i__25123 = G__25132;
continue;
}
} else {
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__25124),router$core$remove_empty_matches_$_iter__25121.call(null,cljs.core.chunk_rest.call(null,s__25122__$2)));
} else {
...
if(((cljs.core._EQ_.call(null,v,"null")) || (cljs.core.empty_QMARK_.call(null,v)))){
return cljs.core.cons.call(null,k,router$core$remove_empty_matches_$_iter__25121.call(null,cljs.core.rest.call(null,s__25122__$2)));
} else {
var G__25133 = cljs.core.rest.call(null,s__25122__$2);
s__25122__$1 = G__25133;
continue;
}
}
} else {
...
return iter__4582__auto__.call(null,matches);
})());
});
router.core.expand_route = (function router$core$expand_route(route){
var strip_slashes = (function (p__25134){
var vec__25135 = p__25134;
var route__$1 = cljs.core.nth.call(null,vec__25135,(0),null);
var defaults = cljs.core.nth.call(null,vec__25135,(1),null);
...
var placeholder = cljs.core.str.cljs$core$IFn$_invoke$arity$1(k);
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(base_url),"?",secretary.core.encode_query_params.call(null,query_params)].join('');
}
});
router.core.route_score = (function router$core$route_score(data,route){
var matched = cljs.core.PersistentVector.EMPTY;
var default_matches = (function (matched__$1){
...
var placeholder_matches = (function (matched__$1){
...
var vec__25139 = clojure.string.split.call(null,url,/\?/);
var u = cljs.core.nth.call(null,vec__25139,(0),null);
var q = cljs.core.nth.call(null,vec__25139,(1),null);
...
var query = router.core.remove_empty_matches.call(null,clojure.walk.keywordize_keys.call(null,secretary.core.decode_query_params.call(null,(function (){var or__4185__auto__ = q;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
return "";
...
return ["?",secretary.core.encode_query_params.call(null,data)].join('');
} else {
var sorted_routes = cljs.core.sort_by.call(null,(function (r){
...
//# sourceMappingURL=core.js.map?rel=1761389400696
