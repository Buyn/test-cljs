...
return m__4488__auto__.call(null,graph,node);
} else {
var m__4485__auto__ = (com.stuartsierra.dependency.immediate_dependencies["_"]);
if((!((m__4485__auto__ == null)))){
return m__4485__auto__.call(null,graph,node);
} else {
...
var x__4487__auto__ = (((graph == null))?null:graph);
var m__4488__auto__ = (com.stuartsierra.dependency.transitive_dependencies_set[goog.typeOf(x__4487__auto__)]);
if((!((m__4488__auto__ == null)))){
return m__4488__auto__.call(null,graph,node_set);
} else {
var m__4485__auto__ = (com.stuartsierra.dependency.transitive_dependencies_set["_"]);
if((!((m__4485__auto__ == null)))){
return m__4485__auto__.call(null,graph,node_set);
} else {
...
var x__4487__auto__ = (((graph == null))?null:graph);
var m__4488__auto__ = (com.stuartsierra.dependency.transitive_dependents_set[goog.typeOf(x__4487__auto__)]);
if((!((m__4488__auto__ == null)))){
return m__4488__auto__.call(null,graph,node_set);
} else {
var m__4485__auto__ = (com.stuartsierra.dependency.transitive_dependents_set["_"]);
if((!((m__4485__auto__ == null)))){
return m__4485__auto__.call(null,graph,node_set);
} else {
...
if((!((m__4488__auto__ == null)))){
return m__4488__auto__.call(null,graph);
} else {
var m__4485__auto__ = (com.stuartsierra.dependency.nodes["_"]);
if((!((m__4485__auto__ == null)))){
return m__4485__auto__.call(null,graph);
} else {
...
if((!((m__4488__auto__ == null)))){
return m__4488__auto__.call(null,graph,node,dep);
} else {
var m__4485__auto__ = (com.stuartsierra.dependency.depend["_"]);
if((!((m__4485__auto__ == null)))){
return m__4485__auto__.call(null,graph,node,dep);
} else {
...
return cljs.core.reduce.call(null,(function (m,p__24799){
var vec__24800 = p__24799;
var k = cljs.core.nth.call(null,vec__24800,(0),null);
var vs = cljs.core.nth.call(null,vec__24800,(1),null);
...
while(true){
var temp__5733__auto__ = cljs.core.seq.call(null,unexpanded);
if(temp__5733__auto__){
var vec__24806 = temp__5733__auto__;
...
var node = first__24808;
var more = seq__24807__$1;
if(cljs.core.contains_QMARK_.call(null,expanded,node)){
var G__24809 = more;
var G__24810 = expanded;
unexpanded = G__24809;
expanded = G__24810;
continue;
} else {
var G__24811 = cljs.core.concat.call(null,more,neighbors.call(null,node));
var G__24812 = cljs.core.conj.call(null,expanded,node);
unexpanded = G__24811;
expanded = G__24812;
continue;
}
...
(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k24814,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k24814,else__4442__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4461__auto__,p__24819){
var vec__24820 = p__24819;
var k__4462__auto__ = cljs.core.nth.call(null,vec__24820,(0),null);
var v__4463__auto__ = cljs.core.nth.call(null,vec__24820,(1),null);
...
return cljs.core.pr_sequential_writer.call(null,writer__4454__auto__,pr_pair__4456__auto__,"#com.stuartsierra.dependency.MapDependencyGraph{",", ","}",opts__4455__auto__,cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),self__.dependencies],null)),(new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"dependents","dependents",136812837),self__.dependents],null))], null),self__.__extmap));
}));

(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__24813){
var self__ = this;
var G__24813__$1 = this;
return (new cljs.core.RecordIter((0),G__24813__$1,2,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),new cljs.core.Keyword(null,"dependents","dependents",136812837)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
return (1526449397 ^ cljs.core.hash_unordered_coll.call(null,coll__4436__auto__));
...
(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this24815,other24816){
var self__ = this;
var this24815__$1 = this;
return (((!((other24816 == null)))) && ((this24815__$1.constructor === other24816.constructor)) && (cljs.core._EQ_.call(null,this24815__$1.dependencies,other24816.dependencies)) && (cljs.core._EQ_.call(null,this24815__$1.dependents,other24816.dependents)) && (cljs.core._EQ_.call(null,this24815__$1.__extmap,other24816.__extmap)));
}));
...
if(cljs.core.contains_QMARK_.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"dependents","dependents",136812837),null,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),null], null), null),k__4449__auto__)){
...
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,self__.__meta,cljs.core.not_empty.call(null,cljs.core.dissoc.call(null,self__.__extmap,k__4449__auto__)),null));
}
}));

(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__24813){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__24823 = cljs.core.keyword_identical_QMARK_;
var expr__24824 = k__4447__auto__;
if(cljs.core.truth_(pred__24823.call(null,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),expr__24824))){
return (new com.stuartsierra.dependency.MapDependencyGraph(G__24813,self__.dependents,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__24823.call(null,new cljs.core.Keyword(null,"dependents","dependents",136812837),expr__24824))){
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,G__24813,self__.__meta,self__.__extmap,null));
} else {
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4447__auto__,G__24813),null));
}
}
}));
...
(com.stuartsierra.dependency.MapDependencyGraph.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__24813){
var self__ = this;
var this__4438__auto____$1 = this;
return (new com.stuartsierra.dependency.MapDependencyGraph(self__.dependencies,self__.dependents,G__24813,self__.__extmap,self__.__hash));
}));
...
var self__ = this;
var graph__$1 = this;
if(cljs.core.truth_((function (){var or__4185__auto__ = cljs.core._EQ_.call(null,node,dep);
if(or__4185__auto__){
...
return cljs.core._write.call(null,writer__4483__auto__,"com.stuartsierra.dependency/MapDependencyGraph");
}));
 ...
 */
com.stuartsierra.dependency.map__GT_MapDependencyGraph = (function com$stuartsierra$dependency$map__GT_MapDependencyGraph(G__24817){
var extmap__4478__auto__ = (function (){var G__24826 = cljs.core.dissoc.call(null,G__24817,new cljs.core.Keyword(null,"dependencies","dependencies",1108064605),new cljs.core.Keyword(null,"dependents","dependents",136812837));
if(cljs.core.record_QMARK_.call(null,G__24817)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__24826);
} else {
return G__24826;
}
})();
return (new com.stuartsierra.dependency.MapDependencyGraph(new cljs.core.Keyword(null,"dependencies","dependencies",1108064605).cljs$core$IFn$_invoke$arity$1(G__24817),new cljs.core.Keyword(null,"dependents","dependents",136812837).cljs$core$IFn$_invoke$arity$1(G__24817),null,cljs.core.not_empty.call(null,extmap__4478__auto__),null));
});
...
return cljs.core.empty_QMARK_.call(null,com.stuartsierra.dependency.immediate_dependents.call(null,graph,p1__24828_SHARP_));
});})(sorted,g))
...
var vec__24835 = cljs.core.seq.call(null,todo);
var seq__24836 = cljs.core.seq.call(null,vec__24835);
var first__24837 = cljs.core.first.call(null,seq__24836);
var seq__24836__$1 = cljs.core.next.call(null,seq__24836);
var node = first__24837;
var more = seq__24836__$1;
var deps = com.stuartsierra.dependency.immediate_dependencies.call(null,g,node);
var vec__24838 = (function (){var deps__$1 = deps;
var g__$1 = g;
...
var G__24841 = cljs.core.rest.call(null,deps__$1);
var G__24842 = g_SINGLEQUOTE_;
var G__24843 = cljs.core.conj.call(null,add,d);
deps__$1 = G__24841;
g__$1 = G__24842;
add = G__24843;
continue;
} else {
var G__24844 = cljs.core.rest.call(null,deps__$1);
var G__24845 = g_SINGLEQUOTE_;
var G__24846 = add;
deps__$1 = G__24844;
g__$1 = G__24845;
add = G__24846;
...
var add = cljs.core.nth.call(null,vec__24838,(0),null);
var g_SINGLEQUOTE_ = cljs.core.nth.call(null,vec__24838,(1),null);
var G__24847 = cljs.core.cons.call(null,node,sorted);
var G__24848 = com.stuartsierra.dependency.remove_node.call(null,g_SINGLEQUOTE_,node);
var G__24849 = clojure.set.union.call(null,cljs.core.set.call(null,more),cljs.core.set.call(null,add));
sorted = G__24847;
g = G__24848;
todo = G__24849;
continue;
...
//# sourceMappingURL=dependency.js.map?rel=1761389399926
