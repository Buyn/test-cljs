...
return (new CustomEvent(event_name,(function (){var obj28055 = ({"detail":data});
return obj28055;
})()));
} else {
...
var f = (function (){var pred__28062 = cljs.core._EQ_;
var expr__28063 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28062.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28063))){
return (function (p1__28056_SHARP_){
return console.warn(p1__28056_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28062.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28063))){
return (function (p1__28057_SHARP_){
return console.debug(p1__28057_SHARP_);
});
} else {
if(cljs.core.truth_(pred__28062.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28063))){
return (function (p1__28058_SHARP_){
return console.error(p1__28058_SHARP_);
});
} else {
return (function (p1__28059_SHARP_){
return console.log(p1__28059_SHARP_);
});
}
}
}
...
var map__28067__$1 = (((((!((map__28067 == null))))?(((((map__28067.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28067.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28067):map__28067);
var opts = map__28067__$1;
var eval_fn = cljs.core.get.call(null,map__28067__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__28069_SHARP_){
return new_def.callback(p1__28069_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__28070){
var vec__28071 = p__28070;
var ky = cljs.core.nth.call(null,vec__28071,(0),null);
var v = cljs.core.nth.call(null,vec__28071,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1761389406799
